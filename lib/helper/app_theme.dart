...
class AppTheme {
  // ── main/brand colors ───
  static const Color primary = Colors.white;// main color
  static const Color secondary = Color.fromARGB(157, 215, 214, 214);
  static const Color tertiary= Color.fromRGBO(92, 92, 92, 1);
  ...
  static const Color muted      = Color.fromARGB(255, 102, 104, 114); // placeholder text
